...
| :---: | :---- |
| 1 | このターン終了後追加でターンを得る。|
| 2 | 手札が7枚になるようにカードをドローする。|
| 3 | デッキの中からカードを1枚選択し、手札に加える。|
| 4 | カードを2枚ドローする。その後手札から2枚カードを選択し、デッキに戻す。|
| 5 | カードを1枚ドローする。その後手札から1枚カードを選択し、デッキに戻す。|
| 6 | デッキの上から2枚カードを確認する。その中からカードを1枚選択し、デッキの一番上におく。もう1枚のカードをデッキの一番下におく。 |
| 8 | デッキの上から2枚カードを確認する。その中からカードを1枚選択し、デッキの一番上におく。もう1枚のカードをデッキの一番下におく。 |
| 9 | カードを1枚ドローする。その後手札から1枚カードを選択し、デッキに戻す。|
| 10 | カードを1枚ドローする。 |
| 11 | カードを2枚ドローする。 |
| 12 | カードを3枚ドローする。 |
| 13 | デッキの中からカードを2枚選択し、手札に加える。|

## ハート
| 数 | 効果 |
| :---: | :---- |
| 1 | このターン終了後追加でターンを得る。|
| 2 | 相手の手札を全てのデッキに戻す。その後相手は元の枚数より1枚少ない枚数カードをドローする。 |
| 3 | 相手の手札を確認する。その中からカードを1枚選択し、デッキに戻す。 |
| 4 | 相手の手札からランダムに1枚デッキに戻す。 |
| 5 | 相手の手札からランダムに1枚デッキに戻す。 その後相手は1枚ドローする。 |
| 6 | 相手のデッキの上から2枚カードを確認する。その中からカードを1枚選択し、相手のデッキの一番上におく。もう1枚のカードを相手のデッキの一番下におく。 |
| 8 | 相手のデッキの上から2枚カードを確認する。その中からカードを1枚選択し、相手のデッキの一番上におく。もう1枚のカードを相手のデッキの一番下におく。 |
| 9 | 相手の手札からランダムに1枚デッキに戻す。 その後相手は1枚ドローする。 |
| 10 | 相手の手札を確認する。その中からカードを1枚選択し、デッキに戻す。その後相手は1枚ドローする。 |
| 11 | 相手の手札からランダムに2枚デッキに戻す。 |
| 12 | 相手の手札からランダムに3枚デッキに戻す。 |
| 13 | 相手の手札を確認する。その中からカードを2枚選択し、デッキに戻す。 |
...
# 苦労したポイント
## 同期機能
2人のプレイヤーの動きを同期させることに苦労しました。特に手札の位置に関してはプレイヤーによって配置が違うためただ同期をさせただけでは上手くいかないので苦労しました。  
